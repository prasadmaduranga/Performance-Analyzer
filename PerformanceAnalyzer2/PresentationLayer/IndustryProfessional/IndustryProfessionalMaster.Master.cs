...
{
    public partial class IndustryProfessionalMaster : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            //try
            //{
            //    if (Session["role"].ToString().Equals("IndustryProfessional"))
            //    {
        ...
        {
            Response.Redirect("~/PresentationLayer/IndustryProfessional/ViewProfileView.aspx");
