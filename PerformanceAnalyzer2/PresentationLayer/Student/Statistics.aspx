                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <asp:Panel ID="Panel1" class="panel panel-danger" runat="server">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Enter Module Info.</h3>
                                    </div>
                                    <div class="panel-body form-horizontal">
                                        <div class="form-group">

                                            <asp:Label ID="Label9" Width="160px" class="col-lg-3 control-label" runat="server" Text="Select Module"></asp:Label>
                                            ...
                                            <table>
                                                ...
                                                <tr> 
                                                    <td colspan="2" style="padding-left:40px;">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:PerformanceAnalyzerConnectionString %>" SelectCommand="spGetModuleResultForBatch" SelectCommandType="StoredProcedure">
                                                            <SelectParameters>
                                                                <asp:SessionParameter Name="courseID" SessionField="statCourseID" Type="Int32" />
                                                                <asp:ControlParameter ControlID="DropDownList1" Name="moduleCode" PropertyName="SelectedValue" Type="String" />
                                                            </SelectParameters>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:PerformanceAnalyzerConnectionString %>" SelectCommand="SELECT       ResultMapping.result, count(Student.userID) as NumofStudents
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <asp:Panel ID="Panel2" class="panel panel-danger" runat="server">
                                    ...
                                    <div class="panel-body form-horizontal" style="padding-bottom: 15px">
                                        <div class="form-group">

                                            <%--          <asp:Label ID="Label4" Width="160px" class="col-lg-3 control-label" runat="server" Text="Select Module"></asp:Label>--%>
                                            ...
                                            <table style="width: 100%">
                                                <%-- <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:PerformanceAnalyzerConnectionString %>" SelectCommand="spGetModuleResultForBatch" SelectCommandType="StoredProcedure">
                                                            <SelectParameters>
                                                                <asp:SessionParameter Name="courseID" SessionField="statCourseID" Type="Int32" />
                                                                <asp:ControlParameter ControlID="DropDownList1" Name="moduleCode" PropertyName="SelectedValue" Type="String" />
                                                            </SelectParameters>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<%$ ConnectionStrings:PerformanceAnalyzerConnectionString %>" SelectCommand="spGetModuleResultForBatchGraph" SelectCommandType="StoredProcedure">
                                                            <SelectParameters>
                                                                <asp:SessionParameter Name="courseID" SessionField="statCourseID" Type="Int32" />
                                                                <asp:ControlParameter ControlID="DropDownList1" Name="moduleCode" PropertyName="SelectedValue" Type="String" />
                                                            </SelectParameters>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="GridView6" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="result" DataSourceID="SqlDataSource2" CssClass="table table-striped table-hover  table-condensed  gridViewCustom" GridLines="Horizontal" OnPageIndexChanging="GridView1_PageIndexChanging">
                                                            <Columns>
                                                                <asp:BoundField DataField="indexNo" HeaderText="Index No" SortExpression="indexNo" />
                                                                <asp:BoundField DataField="userName" HeaderText="Name" SortExpression="userName" />
                                                                <asp:BoundField DataField="result" HeaderText="Result" ReadOnly="True" SortExpression="result" />
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource11" runat="server" ConnectionString="<%$ ConnectionStrings:PerformanceAnalyzerConnectionString %>" SelectCommand="spGetModuleResultForBatch" SelectCommandType="StoredProcedure">
                                                            <SelectParameters>
                                                                <asp:SessionParameter Name="courseID" SessionField="statCourseID" Type="Int32" />
                                                                <asp:ControlParameter ControlID="DropDownList1" Name="moduleCode" PropertyName="SelectedValue" Type="String" />
                                                            </SelectParameters>
                                                    ...
                                                    <td>
                                                        ...
                                                        <asp:Chart ID="Chart2" runat="server" DataSourceID="SqlDataSource14" Width="387px">
                                                            <Series>
                                                                <asp:Series ChartType="Spline" BorderWidth="3" Name="Series1" XValueMember="GPA" YValueMembers="studentCount" ChartArea="ChartArea1">
                                                                </asp:Series>
                                                            </Series>
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:PerformanceAnalyzerConnectionString %>" SelectCommand="spGetModuleResultForBatchGraph" SelectCommandType="StoredProcedure">
                                                            <SelectParameters>
                                                                <asp:SessionParameter Name="courseID" SessionField="statCourseID" Type="Int32" />
                                                                <asp:ControlParameter ControlID="DropDownList1" Name="moduleCode" PropertyName="SelectedValue" Type="String" />
                                                            </SelectParameters>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="GridView9" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource3" CssClass="table table-striped table-hover  table-condensed  gridViewCustom" GridLines="Horizontal">
                                                            <Columns>
                                                                <asp:BoundField DataField="result" HeaderText="Result" SortExpression="result" />
                                                                <asp:BoundField DataField="numOfStudents" HeaderText="Num.Of Students" ReadOnly="True" SortExpression="numberOfStudents" />
                                                            </Columns>
                                                        </asp:GridView>
                                                        <asp:SqlDataSource ID="SqlDataSource13" runat="server" ConnectionString="<%$ ConnectionStrings:PerformanceAnalyzerConnectionString %>" SelectCommand="SELECT       ResultMapping.result, count(Student.userID)as NumofStudents
...
group by  ResultMapping.result ">
                                                    ...
                                                    <td>
                                                        <asp:Chart ID="Chart6" runat="server" DataSourceID="SqlDataSource3" Height="232px" OnPrePaint="Chart1_PrePaint" Palette="EarthTones" Width="224px">
                                                            <Series>
                                                                <asp:Series Name="Series1" IsValueShownAsLabel="true" ShadowColor="Transparent" IsXValueIndexed="true" ChartType="Pie" XValueMember="result" YValueMembers="NumofStudents">
                                                                </asp:Series>
                                                            </Series>
                                    ...
                                    <asp:Panel ID="Panel3" class="panel panel-danger" runat="server">
                                        ...
                                        <div class="panel-body form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <asp:Label ID="Label7" Width="160px" class="col-lg-3 control-label" runat="server" Text="Select Course"></asp:Label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:Label ID="Label13" Width="160px" class="col-lg-3 control-label" runat="server" Text="Select Senester"></asp:Label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:Label ID="Label14" Width="160px" class="col-lg-3 control-label" runat="server" Text="Select Module"></asp:Label>
                                    ...
                                    <asp:Panel ID="Panel4" class="panel panel-danger" runat="server">
                                        ...
                                        <div class="panel-body form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <asp:Label ID="Label10" runat="server" Width="160px" class="col-lg-3 control-label" Text="Select Student"></asp:Label>
