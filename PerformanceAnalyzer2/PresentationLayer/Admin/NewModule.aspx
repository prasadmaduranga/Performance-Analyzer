        ...
        <asp:DetailsView ID="DetailsView1" runat="server" DefaultMode="Insert"  AutoGenerateRows="False" OnItemInserted="DetailsView1_ItemInserted" OnItemInserting="DetailsView1_ItemInserting" HeaderText="Add New Module" OnPreRender="DetailsView1_PreRender" CssClass="table-condensed  table-striped  detailsView" HorizontalAlign="Center" >
            <Fields>
                ...
                <asp:TemplateField HeaderText="Name">
                    ...
                    <InsertItemTemplate>
                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("name") %>'></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                    </InsertItemTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Credits">
                    ...
                    <InsertItemTemplate>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox3" ValidationExpression="^(?:\d{1,2})?(?:\.\d{1,2})?$" ErrorMessage="*Invaid" ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
                    </InsertItemTemplate>
                    <ItemTemplate>
