...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sidebar-nav" id="sidebar">
        <div class="navbar navbar-default" role="navigation">
            ...
            <asp:Menu ID="Menu1" runat="server" Width="244px" StaticMenuStyle-Width="100%" OnMenuItemClick="Menu2_MenuItemClick" StaticMenuStyle-CssClass="nav navbar-nav" class="navbar-collapse collapse sidebar-navbar-collapse">
...
">
                                    ...
                                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="courseID" OnItemUpdating="DetailsView1_ItemUpdating" CssClass="table-condensed table-striped  detailsView  gridview" HeaderText="Edit Course Info" DefaultMode="Edit" GridLines="Horizontal" HorizontalAlign="Center" Width="486px">
                                        <Fields>
                                            <asp:TemplateField HeaderText="Course name">
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("name") %>'></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" Display="Dynamic" ErrorMessage="*Required" ForeColor="Red" ValidationGroup="g5"></asp:RequiredFieldValidator>
                                                </EditItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Batch">
                                                <EditItemTemplate>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DropDownList5" Display="Dynamic" ErrorMessage="*Required" ForeColor="Red" InitialValue="-1" ValidationGroup="g5"></asp:RequiredFieldValidator>
                                                </EditItemTemplate>
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="University">
                                                <EditItemTemplate>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="DropDownList6" Display="Dynamic" ErrorMessage="*Required" ForeColor="Red" InitialValue="-1" ValidationGroup="g5"></asp:RequiredFieldValidator>
                                                    <br />
                                            ...
                                            <asp:TemplateField HeaderText="Faculty ">
                                                <EditItemTemplate>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="DropDownList7" Display="Dynamic" ErrorMessage="*Required" ForeColor="Red" InitialValue="-1" ValidationGroup="g5"></asp:RequiredFieldValidator>
                                                </EditItemTemplate>
                                                <InsertItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Department">
                                                <EditItemTemplate>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="DropDownList8" Display="Dynamic" ErrorMessage="*Required" ForeColor="Red" InitialValue="-1" ValidationGroup="g5"></asp:RequiredFieldValidator>
                                                </EditItemTemplate>
                                                <ItemTemplate>
...
">
                                        ...
                                        <FooterTemplate>
                                            <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click" ValidationGroup="g5">Update</asp:LinkButton>
                                        </FooterTemplate>
                                    </asp:DetailsView>
...
where courseID=@courseID">
                ...
                <asp:View ID="View2" runat="server">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <asp:Label ID="Label2" runat="server" Text="Module Information"></asp:Label>
                        ...
                        <div class="panel-body">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <div style="width: 910px;">
                                            <asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False" DataSourceID="SqlDataSource6" DefaultMode="Insert" HeaderText="Add New Modules " OnItemInserted="DetailsView2_ItemInserted" OnItemInserting="DetailsView2_ItemInserting" OnPreRender="DetailsView2_PreRender" CssClass=" gridview table-condensed  table-striped  detailsView" GridLines="Horizontal" HorizontalAlign="Center">
                                                <Fields>
                                                    <asp:BoundField DataField="semesterID" HeaderText="semesterID" InsertVisible="False" ReadOnly="True" SortExpression="semesterID" Visible="False" />
                                                    <asp:TemplateField HeaderText="moduleCode" SortExpression="moduleCode">
                                                        <EditItemTemplate>
                ...
                <asp:View ID="View3" runat="server">
                    ...
                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True" DataKeyNames="userID" GridLines="Horizontal" OnRowEditing="GridView3_RowEditing" OnRowUpdating="GridView3_RowUpdating" AllowPaging="True" OnRowUpdated="GridView3_RowUpdated" CssClass="gridview  table table-striped table-hover  table-condensed  gridViewCustom" HorizontalAlign="Center" OnPageIndexChanging="GridView3_PageIndexChanging">
                        <Columns>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <asp:Label ID="Label6" runat="server" Text="Student Information"></asp:Label>
