            ...
            <asp:MultiView ID="MultiView1" runat="server">
                ...
                <asp:View ID="View2" runat="server">
                    <%--        <table>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView2"  runat="server" DataKeyNames="courseID" AutoGenerateColumns="False" DataSourceID="SqlDataSource4" OnRowCommand="GridView2_RowCommand" GridLines="Horizontal" CssClass="table table-striped table-hover  table-condensed  gridViewCustom editCustom">
                                    <Columns>
                            ...
                            <asp:Panel ID="Panel2" class="panel panel-danger" runat="server">
                                ...
                                <div class="panel-body form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="Label3" runat="server" Width="160px" class="col-lg-3 control-label" Text="Select University"></asp:Label>
                                        <div class="col-lg-4">
                                            <asp:DropDownList ID="DropDownList1" runat="server" AppendDataBoundItems="true" DataSourceID="SqlDataSource3" DataTextField="name" DataValueField="universityID" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                                <asp:ListItem Selected="True" Value="-1">--Select University--</asp:ListItem>
                                            </asp:DropDownList>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <table style="width:100%;">
                                            <tr>
                                                <td colspan="2">
                                                    <asp:GridView ID="GridView2" runat="server" DataKeyNames="courseID" AutoGenerateColumns="False" DataSourceID="SqlDataSource4" OnRowCommand="GridView2_RowCommand" GridLines="Horizontal" CssClass="table table-striped table-hover  table-condensed  gridViewCustom editCustom gridview" HorizontalAlign="Center">
                                                        <Columns>
                                                            <asp:BoundField DataField="courseID" Visible="false" HeaderText="CourseID" />
                                                            <asp:BoundField DataField="description" HeaderText="Course" />
                                                            <asp:TemplateField>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <asp:DetailsView ID="DetailsView2" runat="server" AutoGenerateRows="False" HeaderText="Course Details" CssClass="table-condensed  table-striped  detailsView gridview" GridLines="Horizontal" HorizontalAlign="Center">
                                                        <Fields>
                                                            <asp:BoundField DataField="name" HeaderText="Course" />
                                                            <asp:BoundField DataField="batch" HeaderText="Batch" />
                                                            <asp:BoundField DataField="deptName" HeaderText="Department" />
