...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <div class="statSpecial compareSpecial">
                                ...
                                <asp:Panel ID="Panel3" class="panel panel-danger" runat="server">
                                    ...
                                    <div class="panel-body form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="Label1" runat="server" Width="160px" class="col-lg-3 control-label" Text="Select Student"></asp:Label>
                                            <div class="col-lg-4">
                                                <asp:DropDownList ID="DropDownList1" AppendDataBoundItems="True" runat="server" DataSourceID="SqlDataSource1" DataTextField="indexNo" DataValueField="userID" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="True">
                                                    <asp:ListItem Text="--Select Student--" Value="-1"></asp:ListItem>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="Label3" runat="server" Width="160px" class="col-lg-3 control-label" Text="Select Module"></asp:Label>
                                            <div class="col-lg-4">
                                                <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource2" AppendDataBoundItems="True" DataTextField="name" DataValueField="moduleCode" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AutoPostBack="True">
                                                    <asp:ListItem Text="--Select Module--" Value="-1"></asp:ListItem>
                                                </asp:DropDownList>
                                ...
                                <asp:Panel ID="Panel4" class="panel panel-danger" runat="server">
                                    ...
                                    <div class="panel-body form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="Label7" Width="160px" class="col-lg-3 control-label" runat="server" Text="Select First Student"></asp:Label>
                                            <div class="col-lg-4">
                                                <asp:DropDownList ID="DropDownList3" AppendDataBoundItems="True" runat="server" DataSourceID="SqlDataSource5" DataTextField="indexNo" DataValueField="userID" AutoPostBack="True" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged">
                                                    <asp:ListItem Text="--Select Student--" Value="-1"></asp:ListItem>
...
">
                    ...
                    <asp:View ID="View4" runat="server">
                        <%--   <table style="width: 100%;">
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="Label60" runat="server" Text="Select Semester"></asp:Label>
                                </td>
                                <td>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <asp:Panel ID="Panel5" class="panel panel-danger" runat="server">
                                    <div class="panel-heading">
                                    ...
                                    <div class="panel-body form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="Label60" Width="160px" class="col-lg-3 control-label" runat="server" Text="Select Semester"></asp:Label>
                                            <div class="col-lg-4">
                                                <asp:DropDownList ID="DropDownList7" runat="server" DataSourceID="SqlDataSource12" AppendDataBoundItems="True" DataTextField="semester" DataValueField="semesterID" AutoPostBack="True" OnSelectedIndexChanged="DropDownList7_SelectedIndexChanged">
                                                    <asp:ListItem Text="--Select Semester--" Value="-1"></asp:ListItem>
                                                </asp:DropDownList>
                        ...
                        <%--<table style="width: 100%;">
                            <tr>
                                ...
                                <asp:Panel ID="Panel7" class="panel panel-danger" runat="server">
                                    ...
                                    <div class="panel-body form-horizontal">
                                        <div class="form-group">
                                            <asp:Label ID="Label23" Width="200px" class="col-lg-3 control-label" runat="server" Text="Select Semester"></asp:Label>
                                            <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            <asp:Label ID="Label8" Width="200px" class="col-lg-3 control-label" runat="server" Text="Select First Student"></asp:Label>
...
<%--                        <table style="width: 100%;">
                                ...
                                <asp:Panel ID="Panel8" class="panel panel-danger" runat="server">
                                    ...
                                    <div class="panel-body form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="Label44" Width="160px" class="col-lg-3 control-label" runat="server" Text="Select Student"></asp:Label>
                                            <div class="col-lg-4">
                                ...
                                <asp:Panel ID="Panel9" class="panel panel-danger" runat="server">
                                    ...
                                    <div class="panel-body form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:Label ID="Label49" Width="200px" class="col-lg-3 control-label" runat="server" Text="Select Second Student"></asp:Label>
                                            <div class="col-lg-4">
                                                <asp:DropDownList ID="DropDownList11" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource27" DataTextField="indexNo" DataValueField="userID" AutoPostBack="True" OnSelectedIndexChanged="DropDownList11_SelectedIndexChanged">
                                                    <asp:ListItem Text="--Select Student--" Value="-1"></asp:ListItem>
                                                </asp:DropDownList>
                    ...
                    <asp:View ID="View10" runat="server">
                        <div class="jumbotron">
                            <h3>First Select Your Choice From Menu! </h3>
