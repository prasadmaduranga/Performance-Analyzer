                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <table>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource3" CssClass="gridviewsmall  table table-striped table-hover  table-condensed  gridViewCustom" GridLines="Horizontal">
                                                            <Columns>
...
group by  ResultMapping.result ">
                                                    ...
                                                    <td>
                                                        <asp:Chart ID="Chart3" runat="server" DataSourceID="SqlDataSource14" OnLoad="Chart3_Load" Width="398px" CssClass="chartsmall">
                                                            <Series>
                                        ...
                                        <div class="panel-body">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Chart ID="Chart2" runat="server" DataSourceID="SqlDataSource6" Height="251px" OnPrePaint="Chart1_PrePaint" Palette="EarthTones" Width="401px" CssClass="chartsmall" OnLoad="Chart2_Load">
                                                            <Series>
                                                                <asp:Series Name="Series1" IsValueShownAsLabel="true" ShadowColor="Transparent" IsXValueIndexed="true" XValueMember="GPARange" YValueMembers="stdCount">
                                                                </asp:Series>
                                                            </Series>
                                        ...
                                        <div class="panel-body">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Chart ID="Chart4" runat="server" DataSourceID="SqlDataSource7" Height="251px" OnPrePaint="Chart1_PrePaint" Palette="EarthTones" Width="401px" CssClass="chartsmall" OnLoad="Chart4_Load">
                                                            <Series>
                                                                <asp:Series Name="Series1" IsValueShownAsLabel="true" ShadowColor="Transparent" IsXValueIndexed="true" XValueMember="GPARange" YValueMembers="stdCount">
                                                                </asp:Series>
                                                            </Series>
...
group by  ResultMapping.result ">
                                ...
                                <td>
                                    <asp:Chart ID="Chart5" runat="server" DataSourceID="SqlDataSource15" OnPrePaint="Chart5_PrePaint" Palette="EarthTones" Height="258px" Width="339px">
                                        <Series>
                                ...
                                <asp:Panel ID="Panel4" class="panel panel-danger" runat="server">
                                    ...
                                    <div class="panel-body form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-4">
                                                <asp:DropDownList ID="DropDownList3" runat="server" AppendDataBoundItems="True" DataSourceID="SqlDataSource12" DataTextField="semester" DataValueField="semesterID" AutoPostBack="True" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
                                                    <asp:ListItem Text="--Select Semester--" Value="-1"></asp:ListItem>
                                                </asp:DropDownList>
                                                <br />
                                                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:PerformanceAnalyzerConnectionString %>" SelectCommand="SELECT distinct semesterID, (cast(semesterNumber as nvarchar(10))+' Semester') as semester FROM AcedamicInfo WHERE (courseID =@courseID)">
                                                    <SelectParameters>
                                                        <asp:SessionParameter Name="courseID" SessionField="statCourseID" />
                                                    </SelectParameters>
                                                </asp:SqlDataSource>
                                            ...
                                            <table>
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:PerformanceAnalyzerConnectionString %>" SelectCommand="spGetSemesterRankings" SelectCommandType="StoredProcedure">
                                                            <SelectParameters>
                                                                <asp:ControlParameter ControlID="DropDownList2" Name="semesterID" PropertyName="SelectedValue" Type="Int32" />
                                                                <asp:SessionParameter Name="courseID" SessionField="statCourseId" Type="Int32" />
                                                            </SelectParameters>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="GridView8" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource6" CssClass="table table-striped table-hover  table-condensed  gridViewCustom" GridLines="Horizontal">
                                                            <Columns>
                                                                <asp:BoundField DataField="GPARange" HeaderText="Range" />
                                                                <asp:BoundField DataField="stdCount" HeaderText="Num Of Students" />
                                                            </Columns>
                                                        </asp:GridView>
                                                        <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:PerformanceAnalyzerConnectionString %>" SelectCommand="spGetSemesterRanges" SelectCommandType="StoredProcedure">
                                                            <SelectParameters>
                                                                <asp:ControlParameter ControlID="DropDownList2" Name="semesterID" PropertyName="SelectedValue" Type="Int32" />
                                                                <asp:SessionParameter Name="courseID" SessionField="statCourseID" />
                                                            </SelectParameters>
                                                    ...
                                                    <td>
                                                        <asp:Chart ID="Chart1" runat="server" DataSourceID="SqlDataSource6" Height="232px" OnPrePaint="Chart1_PrePaint" Palette="EarthTones" Width="224px">
                                                            <Series>
                                                                <asp:Series Name="Series1" IsValueShownAsLabel="true" ShadowColor="Transparent" IsXValueIndexed="true" XValueMember="GPARange" YValueMembers="stdCount">
                                                                </asp:Series>
                                                            </Series>
                    ...
                    <asp:View ID="View5" runat="server">
                       <div class="jumbotron" style="margin-top:15px;    margin-top: 15px;
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <table>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="userID" OnDataBound="DetailsView1_DataBound" Style="margin-right: 1px" CssClass="table-condensed  table-striped  detailsView  profile" GridLines="Horizontal" HeaderText="Profile" HorizontalAlign="Center" Width="400px">
                                                            <Fields>
                                                                <asp:TemplateField HeaderText="Name" SortExpression="userName">
                                                                    <EditItemTemplate>
                                                                        <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("userName") %>'></asp:TextBox>
